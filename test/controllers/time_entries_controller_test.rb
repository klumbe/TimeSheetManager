...
class TimeEntriesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create time_entry" do
    assert_difference('TimeEntry.count') do
      post time_entries_url, params: { time_entry: { breaks: @time_entry.breaks, date: @time_entry.date, end: @time_entry.end, start: @time_entry.start, total: @time_entry.total } }
    end
  ...
  test "should update time_entry" do
    patch time_entry_url(@time_entry), params: { time_entry: { breaks: @time_entry.breaks, date: @time_entry.date, end: @time_entry.end, start: @time_entry.start, total: @time_entry.total } }
