...
class LogsTest < ApplicationSystemTestCase
  ...
  test "creating a Log" do
    ...
    fill_in "Changed at", with: @log.changed_at
    fill_in "Changed by", with: @log.changed_by
    fill_in "Changed to", with: @log.changed_to
    fill_in "Column", with: @log.column
    fill_in "Row", with: @log.row
    fill_in "Table", with: @log.table
    click_on "Create Log"
